const products = {
  ...
  aw720m: {
    ...
    viewFeatures: {
      ...
      1: [[3, 39, 46, 14, 50], [4, 50, 58, 27, 67], [5, 49.5, 40, 67, 38], [6, 61, 46, 73, 52]],
    ...
    features: [
      ...
      ["三模选择开关", "底部切换 2.4GHz、蓝牙或有线模式。", 39, 46, 14, 50],
      ["DPI 调整按钮", "底部切换五档 DPI。", 50, 58, 27, 67],
      ["DPI 指示器", "底部指示当前 DPI 档位。", 49.5, 40, 67, 38],
      ["电源按钮", "底部电源开关。", 61, 46, 73, 52],
