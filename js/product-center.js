const products = {
  ...
  aw720m: {
    ...
    viewFeatures: {
      ...
      1: [[3, 32, 53, 12, 55], [4, 50, 69, 28, 72], [5, 50, 45, 68, 43], [6, 69, 53, 80, 58]],
    ...
    features: [
      ...
      ["三模选择开关", "底部切换 2.4GHz、蓝牙或有线模式。", 32, 53, 12, 55],
      ["DPI 调整按钮", "底部切换五档 DPI。", 50, 69, 28, 72],
      ["DPI 指示器", "底部指示当前 DPI 档位。", 50, 45, 68, 43],
      ["电源按钮", "底部电源开关。", 69, 53, 80, 58],
